...
RecRoom::SupervoxelClustering<PointT>::SupervoxelClustering(float voxel_resolution, float seed_resolution) :
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
RecRoom::SupervoxelClustering<PointT>::~SupervoxelClustering()
{
...
RecRoom::SupervoxelClustering<PointT>::setInputCloud(const typename pcl::PointCloud<PointT>::ConstPtr& cloud)
{
	if (cloud->size() == 0)
	{
		PCL_ERROR("[RecRoom::SupervoxelClustering::setInputCloud] Empty cloud set, doing nothing \n");
		return;
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setNormalCloud(typename NormalCloudT::ConstPtr normal_cloud)
{
	if (normal_cloud->size() == 0)
	{
		PCL_ERROR("[RecRoom::SupervoxelClustering::setNormalCloud] Empty cloud set, doing nothing \n");
		return;
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::extract(std::map<uint32_t, typename Supervoxel<PointT>::Ptr > &supervoxel_clusters)
{
	//timer_.reset ();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::refineSupervoxels(int num_itr, std::map<uint32_t, typename Supervoxel<PointT>::Ptr > &supervoxel_clusters)
{
	if (supervoxel_helpers_.size() == 0)
	{
		PCL_ERROR("[RecRoom::SupervoxelClustering::refineVoxelNormals] Supervoxels not extracted, doing nothing - (Call extract first!) \n");
		return;
	}
...
RecRoom::SupervoxelClustering<PointT>::prepareForSegmentation()
{
...
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::computeVoxelData()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::expandSupervoxels(int depth)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::makeSupervoxels(std::map<uint32_t, typename Supervoxel<PointT>::Ptr > &supervoxel_clusters)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::createSupervoxelHelpers(std::vector<int> &seed_indices)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::selectInitialSupervoxelSeeds(std::vector<int> &seed_indices)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::reseedSupervoxels()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::transformFunction(PointT &p)
{
	p.x /= p.z;
	p.y /= p.z;
	p.z = std::log(p.z);
...
RecRoom::SupervoxelClustering<PointT>::voxelDataDistance(const VoxelData &v1, const VoxelData &v2) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::getSupervoxelAdjacencyList(VoxelAdjacencyList &adjacency_list_arg) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::getSupervoxelAdjacency(std::multimap<uint32_t, uint32_t> &label_adjacency) const
{
...
RecRoom::SupervoxelClustering<PointT>::getVoxelCentroidCloud() const
{
...
RecRoom::SupervoxelClustering<PointT>::getLabeledVoxelCloud() const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> pcl::PointCloud<pcl::PointXYZL>::Ptr
RecRoom::SupervoxelClustering<PointT>::getLabeledCloud() const
{
...
RecRoom::SupervoxelClustering<PointT>::makeSupervoxelNormalCloud(std::map<uint32_t, typename Supervoxel<PointT>::Ptr > &supervoxel_clusters)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> float
RecRoom::SupervoxelClustering<PointT>::getVoxelResolution() const
{
	return (resolution_);
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setVoxelResolution(float resolution)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> float
RecRoom::SupervoxelClustering<PointT>::getSeedResolution() const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setSeedResolution(float seed_resolution)
{
	seed_resolution_ = seed_resolution;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setColorImportance(float val)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setSpatialImportance(float val)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setNormalImportance(float val)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::setUseSingleCameraTransform(bool val)
{
...
RecRoom::SupervoxelClustering<PointT>::getMaxLabel() const
{
	int max_label = 0;
	for (typename HelperListT::const_iterator sv_itr = supervoxel_helpers_.cbegin(); sv_itr != supervoxel_helpers_.cend(); ++sv_itr)
	{
...
namespace pcl
{
	namespace octree
	{
		...
		template<> void pcl::octree::OctreePointCloudAdjacencyContainer<pcl::PointXYZRGB, RecRoom::SupervoxelClustering<pcl::PointXYZRGB>::VoxelData>::addPoint(const pcl::PointXYZRGB &new_point)
		{
			++num_points_;
			//Same as before here
		...
		template<> void pcl::octree::OctreePointCloudAdjacencyContainer<pcl::PointXYZRGBA, RecRoom::SupervoxelClustering<pcl::PointXYZRGBA>::VoxelData>::addPoint(const pcl::PointXYZRGBA &new_point)
		{
			++num_points_;
			//Same as before here
			data_.xyz_[0] += new_point.x;
		...
		template<> void pcl::octree::OctreePointCloudAdjacencyContainer<pcl::PointXYZ, RecRoom::SupervoxelClustering<pcl::PointXYZ>::VoxelData>::addPoint(const pcl::PointXYZ &new_point)
		{
			++num_points_;
			//Same as before here
			data_.xyz_[0] += new_point.x;
		...
		//Explicit overloads for RGB types
		template<> void pcl::octree::OctreePointCloudAdjacencyContainer<pcl::PointXYZRGB, RecRoom::SupervoxelClustering<pcl::PointXYZRGB>::VoxelData>::computeData()
		{
		...
		template<> void pcl::octree::OctreePointCloudAdjacencyContainer<pcl::PointXYZRGBA, RecRoom::SupervoxelClustering<pcl::PointXYZRGBA>::VoxelData>::computeData()
		{
			data_.rgb_[0] /= (static_cast<float> (num_points_));
			data_.rgb_[1] /= (static_cast<float> (num_points_));
			data_.rgb_[2] /= (static_cast<float> (num_points_));
		...
		template<> void pcl::octree::OctreePointCloudAdjacencyContainer<pcl::PointXYZ, RecRoom::SupervoxelClustering<pcl::PointXYZ>::VoxelData>::computeData()
		{
			data_.xyz_[0] /= (static_cast<float> (num_points_));
			data_.xyz_[1] /= (static_cast<float> (num_points_));
			data_.xyz_[2] /= (static_cast<float> (num_points_));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<> void RecRoom::SupervoxelClustering<pcl::PointXYZRGB>::VoxelData::getPoint(pcl::PointXYZRGB &point_arg) const
{
...
template<> void RecRoom::SupervoxelClustering<pcl::PointXYZRGBA>::VoxelData::getPoint(pcl::PointXYZRGBA &point_arg) const
{
	point_arg.rgba = static_cast<uint32_t>(rgb_[0]) << 16 |
		static_cast<uint32_t>(rgb_[1]) << 8 |
		static_cast<uint32_t>(rgb_[2]);
...
template<typename PointT> void RecRoom::SupervoxelClustering<PointT>::VoxelData::getPoint(PointT &point_arg) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void RecRoom::SupervoxelClustering<PointT>::VoxelData::getNormal(pcl::Normal &normal_arg) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::addLeaf(LeafContainerT* leaf_arg)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::removeLeaf(LeafContainerT* leaf_arg)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::removeAllLeaves()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::expand()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::refineNormals()
{
	typename SupervoxelHelper::iterator leaf_itr;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::updateCentroid()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::getVoxels(typename pcl::PointCloud<PointT>::Ptr &voxels) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::getNormals(typename pcl::PointCloud<pcl::Normal>::Ptr &normals) const
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
RecRoom::SupervoxelClustering<PointT>::SupervoxelHelper::getNeighborLabels(std::set<uint32_t> &neighbor_labels) const
{
