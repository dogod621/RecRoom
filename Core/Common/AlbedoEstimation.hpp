...
namespace RecRoom
{
	...
	inline bool AlbedoEstimation<InPointIN, OutPointIN>::CollectScanLaserInfo(const Pc<InPointIN>& cloud, const std::size_t k, const std::vector<int>& indices, const std::vector<float>& distance, const InPointIN& inPoint, std::vector<ScanLaser>& scanLaserSet)
	{
		scanLaserSet.clear();
	...
	template<class InPointIN, class OutPointIN>
	inline bool AlbedoEstimation<InPointIN, OutPointIN>::ComputePointAlbedo(const std::vector<ScanLaser>& scanLaserSet, const InPointIN& inPoint, OutPointIN& outPoint)
	{
		Eigen::MatrixXf A;
		Eigen::MatrixXf B;
	...
	template<class InPointIN, class OutPointIN>
	void AlbedoEstimation<InPointIN, OutPointIN>::computeFeature(PointCloudOut &output)
	{
